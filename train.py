...
def main():
    ...
    if args.cuda:
        try:
            ...
            raise ValueError('Argument --gpu_ids must be a comma-separated list\
                             of integers only')
    ...
    if args.lr is None:
        ...
        args.lr = lrs[args.dataset.lower()] / (4 * len(args.gpu_ids)) \
        * args.batch_size
